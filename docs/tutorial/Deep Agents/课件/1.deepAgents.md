...
![](assets/image-20260214223026633.png)
...
![](./assets/image-20260601204501232.png)
...
- deepagents（开箱即用层 / 多智能体套件agent harness）
...
1. 在`.env` 文件中添加如下配置
   ...
   LANGCHAIN_API_KEY=YOUR_LANGSMITH_TOKEN_HERE
   # LangSmith 的 API URL
   ...
   ![](./assets/image-20260531075118154.png)
...
![](assets/image-20260605230424307.png)
...
![](assets/image-20260218202038937.png)
...
![](assets/image-20260312162445613.png)
...
![](assets/image-20260604190518897.png)
...
![](assets/image-20260220001740264.png)
...
```python
"""
测试07_1：智能体的整个工作区目录下：只能读文件，不能写（禁止写入）
"""
import os
...
```python
"""
测试07_2：智能体的整个工作区目录下指定子目录可以读写，其它所有都不可读写
"""
import os
from deepagents import create_deep_agent, FilesystemPermission
from deepagents.backends import FilesystemBackend
