...
![image-20260121201903693](assets/image-20260121201903693.png)
...
![](assets/image-20260121203227857.png)

- column_info

![](assets/image-20260819164640169.png)

### 2.2.4 全文索引

本项目使用 Elasticsearch 作为全文检索引擎，全文索引主要用于对**字段取值**进行检索与匹配，索引内容以各类维度值为主，具体如下：

![](assets/image-20260121204009373.png)

## 2.2 问数智能体

本项目的智能体主体基于Langgraph构建，具体结构如下图所示：

![](assets/掌柜问数项目-问数智能体.drawio.svg)
...
![image-20260121215240284](assets/image-20260121223015280.png)
