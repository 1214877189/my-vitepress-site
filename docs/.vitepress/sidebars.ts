...
export const langchainSidebar: DefaultTheme.SidebarItem[] = [
  {
    text: 'LangChain 课件',
    items: [
...
export const langgraphSidebar: DefaultTheme.SidebarItem[] = [
  {
    text: 'LangGraph 课件',
    items: [
...
export const vibeSidebar: DefaultTheme.SidebarItem[] = [
  {
    text: 'AI Coding 课件',
    items: [
